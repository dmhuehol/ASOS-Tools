%%ASOSnamer
    %Replicates the filename structure generated by ASOSdownloadFiveMin
    %without actually downloading the files.
    %
    %General form: [downloadedFilenames] = ASOSnamer(station,year,month,downloadedFilePath)
    %
    %Inputs:
    ...
    %
    %Outputs:
    %downloadedFilenames: 3D cell array of filenames corresponding to the
    %inputs. D1=year, D2=station, D3=month
    %
    %Version Date: 4/10/2020
    %Last major revision: 4/10/2020
    %Written by: Daniel Hueholt
    %North Carolina State University
    %Undergraduate Research Assistant at Environment Analytics
    %
    
function [downloadedFilenames] = ASOSnamer(station,year,month,downloadedFilePath)
% Check inputs
if nargin~=4
